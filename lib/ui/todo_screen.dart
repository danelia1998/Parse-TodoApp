...
class _TodoScreenState extends State<TodoScreen> {
            ...
            if (snapshot.data != null) {
              ...
              return ListView.builder(
                itemBuilder: (_, position) {
                  return ListTile(
                    title: Text(todoList[position].todo),
                    trailing: Row(
                      ...
                      children: <Widget>[
                        ...
                        IconButton(
                            ...
                            onPressed: () {
                              deleteTodo(todoList[position].id.toString());
                            })
                      ],
                    ),
                  );
  ...
  void showUpdateDialog(Todo todo) {
    _taskController.text = todo.todo;
              ...
              actions: <Widget>[
                FlatButton(
                    onPressed: () {
                      ...
                      todo.todo = _taskController.text;
                      updateTodo(todo);
                    },
                    child: Text("Update")),
                FlatButton(
  ...
  void addTodo() {
    ...
    Todo todo = Todo(todo: _taskController.text);
